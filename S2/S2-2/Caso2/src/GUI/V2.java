...
public class V2 extends JFrame implements ActionListener {
	...
	public V2() {
		...
		txtnum.setBounds(129, 11, 86, 20);
		contentPane.add(txtnum);
		txtnum.setColumns(10);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 82, 205, 168);
		contentPane.add(scrollPane);
		
		txts = new JTextArea();
		scrollPane.setViewportView(txts);
		
		lblNewLabel = new JLabel("Numero Real");
		lblNewLabel.setBounds(10, 14, 86, 14);
		contentPane.add(lblNewLabel);
		
		btnNewButton = new JButton("Procesar");
		btnNewButton.addActionListener(this);
		btnNewButton.setBounds(7, 39, 89, 23);
	...
	protected void do_btnNewButton_actionPerformed(ActionEvent e) {
		...
		Imprimir("El numero es: "+ n.getNumeroReal());
		Imprimir("Su cuadrado es: "+ n.Cuadrado());
		Imprimir("Su cubo es: "+ n.Cubo());
	}
